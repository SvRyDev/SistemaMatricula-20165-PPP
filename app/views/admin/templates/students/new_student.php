...
<div class="mx-auto p-3" style="max-width:1300px">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 p-3 bg-body-secondary">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-floating form-floating-sm ">
                            <input type="date" name="est_fecha_nac" id="est_fecha_nac" class="form-control shadow-sm" value="" autocomplete="off" placeholder="" required>
                            <div class="invalid-feedback">
                                Error
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" name="est_dep_nac" id="est_dep_nac" class="form-control shadow-sm" value="" autocomplete="off" placeholder="" required>
                        <div class="invalid-feedback">
                            Error
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" name="est_prov_nac" id="est_prov_nac" class="form-control shadow-sm" value="" autocomplete="off" placeholder="" required>
                        <div class="invalid-feedback">
                            Error
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" name="est_dist_nac" id="est_dist_nac" class="form-control shadow-sm" value="" autocomplete="off" placeholder="" required>
                        <div class="invalid-feedback">
                            Error
                        </div>
                    </div>
