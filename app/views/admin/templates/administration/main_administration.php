                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mt-2 col-lg-4 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control shadow-sm" name="nombreInstitucion" id="nombreInstitucion" value="<?= $data['data_config']['NOMBRE_ENTIDAD']; ?>" data-maxlength=4 required/>
