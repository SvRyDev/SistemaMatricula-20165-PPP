...
<body class="bg-light d-flex flex-column justify-content-center align-items-center vh-100">
    ...
    <div class="bg-white rounded-3 p-4 m-5 shadow" style="max-width: 400px;">
        ...
        <form action="<?= base_url()?>/home/authenticate" method="POST">
            <div class="mb-3">
                <label for="l_username" class="form-label">Usuario</label>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"><i class="icon-input-form bi bi-person-circle"></i> </span>
                    <input id="l_username" name="l_username" type="text" class="form-control" placeholder="Usuario" aria-label="Username" aria-describedby="basic-addon1" required>
                </div>
            </div>

            <div class="mb-3">
                <label for="l_password" class="form-label">Contraseña</label>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"> <i class="icon-input-form bi bi-unlock-fill"></i> </span>
                    <input id="l_password" name="l_password" type="password" class="form-control" placeholder="***" aria-label="Username" aria-describedby="basic-addon1" required>
                </div>
            </div>


            <button type="submit" class="btn btn-warning"> <i class="bi bi-box-arrow-in-right"></i>Iniciar Sesión</button>
        </form>
    </div>
